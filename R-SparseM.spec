...
Source0  : https://cran.r-project.org/src/contrib/SparseM_1.81.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613661576
...
R CMD INSTALL --preclean --install-tests --no-test-load --built-timestamp=${SOURCE_DATE_EPOCH} --build  -l %{buildroot}/usr/lib64/R/library SparseM
...
R CMD check --no-manual --no-examples --no-codoc SparseM || :
