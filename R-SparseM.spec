...
Version  : 1.76
Release  : 31
URL      : http://cran.r-project.org/src/contrib/SparseM_1.76.tar.gz
Source0  : http://cran.r-project.org/src/contrib/SparseM_1.76.tar.gz
...
%build
export LANG=C
export SOURCE_DATE_EPOCH=1489246524
